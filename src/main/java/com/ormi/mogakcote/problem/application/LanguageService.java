...
public class LanguageService {
    ...
    public SuccessResponse deleteLanguage(Long id) {
        Language findLanguage = getLanguageOrThrowIfNotExist(id);
        languageRepository.deleteByLanguageId(findLanguage.getId());
    ...
    private Language getLanguageOrThrowIfNotExist(Long id) {
        return languageRepository.findByLanguageId(id).orElseThrow(
