...
public class PlatformServcie {
    ...
    public SuccessResponse deletePlatform(Long id){
        Platform findPlatform = getPlatformOrThrowIfNotExist(id);
        platformRepository.deleteByPlatformId(findPlatform.getId());
    ...
    private Platform getPlatformOrThrowIfNotExist(Long id){
        return platformRepository.findByPlatformId(id).orElseThrow(
